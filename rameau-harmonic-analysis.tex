...
notes, rhythm, dynamics, harmony, and by the fact that music is not a
...
so \nota{iara: eu colocaria um ``are'' nesse lugar }very difficult to
...
address this problem.  For simplicity we will refer to them as
