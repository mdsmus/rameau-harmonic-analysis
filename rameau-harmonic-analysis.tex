...
the system described in \cite{illescas.ea:harmonic}, use input
...
algorithm implemented in rameau makes direct use of it yet, since they
are reimplementations of algorithms that expect pitch classes as
input.
...
Herrera \cite{gomez.ea:estimating} do for tonality recognition.
