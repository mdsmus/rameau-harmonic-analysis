...
chord's mode. The framework provides a few possible comparison
functions for easy usage. Chords are represented internally as
structures that may have a root, a mode, a seventh, a bass, and other
additions.
