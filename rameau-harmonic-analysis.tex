...
nine of them using a corpus of 140 Bach chorales from the 371 in
the Riemenschneider edition \cite{bach:371}. Rameau automatically
compares the answers return by the algorithms with answer sheets
...
algorithms found in the literature, other approaches are new, like the
use of decision trees. Another significant difference between our
approach and the others found in the literature is the evaluation of
performance using precision and recall.
