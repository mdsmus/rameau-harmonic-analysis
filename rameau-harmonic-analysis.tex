...
length, making a thorough evaluation of all possibilities impossible
...
\nota{nice -> Use a more exact word.}
...
operations and functions to compare chords names, modes, and roots.
...
usual popular notation, represent inherent ambiguities in chord, and
represent non-chord tones.
...
\nota{reescreve sem interesting (2 vezes!)}
